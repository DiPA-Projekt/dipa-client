    ...
    return (
      <>
        ...
        <div className="grid grid-cols-1">
          <KolForm>
            <KolFieldset>
              <KolHeading slot="legend" _text="Bibliotheken" _level={2}></KolHeading>
              <div
                slot="content"
                className="w-full grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 2xl:grid-cols-4 gap-4"
              >
                <KolControlledInput
          ...
          <KolForm>
            <KolFieldset>
              <KolHeading slot="legend" _level={2} _text="Kopfdaten"></KolHeading>
