...
| --------------------- | ------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------- | ----------- |
| `_disabled`           | `_disabled`   | Gibt an, ob das Button deaktiviert ist.                                                                                                                                                              | `boolean \| undefined`                               | `undefined` |
...
| `_minWidth`           | `_min-width`  | Gibt die Mindesbreite des Buttons an.                                                                                                                                                                | `string \| undefined`                                | `undefined` |
